pipeline {
    ...
    environment {
        DOCKERHUB_CREDENTIALS = credentials('harshithas-dockerhub-creds') //update credentials 
        DOCKER_IMAGE = "harshithashankar02/password-generator"  // update docker image name
        IMAGE_TAG = "${BUILD_NUMBER}"
        NAMESPACE = "harshithas-ns"  // update namespace name
    }
